...
\n## PR <pending> - Security audit automation\n\n- Added `security-audit.js` CLI to run `npm audit` and SBOM generation for each project.\n- Created scheduled GitHub Action and storage folder under analytics.\n- Added portal dashboard page showing vulnerabilities and compliance status.\n- Documented the workflow in `security-compliance.md`.\n
